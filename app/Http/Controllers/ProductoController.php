...
class ProductoController extends Controller
{
    ...
    public function listar(Request $request){
        ...
        ->editColumn("imagen", function($producto){
            ...
            ->addColumn('editar', function ($producto) {
                return '<a class="btn btn-outline-primary btn-sm" href="/producto/editar/'.$producto->id.'">Editar</a>';
            })
            ->addColumn('cambiar', function ($producto) {
                if($producto->estado == 1){
                    return '<a class="btn btn-outline-danger btn-sm" href="/producto/cambiar/estado/'.$producto->id.'/0">Inactivar</a>';
                }else{
                    return '<a class="btn btn-outline-success btn-sm" href="/producto/cambiar/estado/'.$producto->id.'/1">Activar</a>';
                }
    ...
    public function edit($id){
        ...
        if($producto==null){
            Flash::error("Producto no encotrado");
            return redirect("/producto");
