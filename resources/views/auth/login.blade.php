          ...
          <div class="card-group">
                ...
                <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background:#2785a1">
                                    {{ __('Iniciar sesión') }}
                                </button>
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
                <div>
                  <h2>Regístrate</h2>
                  <p>Registra tu usuario para acceder al sitio.</p>
                  <a href="/register"><input class="btn btn-lg btn-outline-light mt-3" type="button" value="!Regístrate ahora!"></a>
                </div>
              </div>
            </div>
          </div>
